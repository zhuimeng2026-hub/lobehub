...
| WeChat Official Account | `wechat-mp`          | `AUTH_WECHAT_MP_APP_ID`, `AUTH_WECHAT_MP_SECRET`                                                                   |
...
<Cards>
  ...
  <Card href={'/docs/self-hosting/auth/providers/wechat-mp'} title={'WeChat Official Account'} />
</Cards>
...
Better Auth supports built-in providers (Google, GitHub, Microsoft, Apple, AWS Cognito) and Generic OIDC providers (Auth0, Authelia, Authentik, Casdoor, Cloudflare Zero Trust, Keycloak, Logto, Okta, ZITADEL, Generic OIDC, Feishu, WeChat, WeChat Official Account).
