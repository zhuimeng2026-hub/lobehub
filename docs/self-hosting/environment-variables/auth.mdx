...
#### `AUTH_WECHAT_MP_APP_ID`

- Type: Required
- Description: AppID of the WeChat Official Account (服务号). Get it from [WeChat Official Account Platform](https://mp.weixin.qq.com/) > Settings & Development > Basic Configuration.
- Default: `-`
- Example: `wxxxxxxxxxxxxxxxxxxx`

#### `AUTH_WECHAT_MP_SECRET`

- Type: Required
- Description: AppSecret of the WeChat Official Account.
- Default: `-`
- Example: `xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`
